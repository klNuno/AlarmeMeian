...
class SMSController(private val context: Context) {
    ...
    private var phoneNumber: String = "+33"
    ...
    fun saveAlarm(code: String, phoneNumber: String) {
        this.code = code
